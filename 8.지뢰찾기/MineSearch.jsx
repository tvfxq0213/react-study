...
export const TableContext = createContext({ // 기본값을 넣어줄 수 있음
  tableData: [], //배열
  halted: true,
  dispatch: () => {}, //함수 - 모양만 일단 맞춰줌
});
...
export const START_GAME = 'START_GAME'; //액션을 만들어 줌
...
const reducer = (state, action) => {
  switch (action.type) {
    case START_GAME: //리듀서를 통해 액션을 정의해 줌
      return {
        ...state,
        data: {
          row: action.row,
...
const MineSearch = () => {
  ...
  return ( //Provider로 묶어줘야 아래 컴포넌트에서 접근 할 수 있음 
    // 매번 새로운 객체가 생기지 않도록 usememo로 캐싱을 함
